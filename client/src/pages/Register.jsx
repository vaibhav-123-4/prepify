...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await post('/auth/register', { email, password, name: fullName });
  ...
  return (
    <div className="flex min-h-screen w-full font-sans bg-[#0D1117] text-white items-center justify-center relative overflow-hidden py-10 px-4">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40vw] h-[40vw] max-w-[500px] max-h-[500px] bg-cyan-600 rounded-full blur-[120px] opacity-20"></div>
      ...
      <div className="absolute top-1/4 left-1/4 text-6xl opacity-20 blur-sm pointer-events-none rotate-12">🚀</div>
      ...
      <div className="max-w-[420px] w-full relative z-10 mt-8">
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] rounded-[2rem] p-8 sm:p-10 flex flex-col justify-center">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-400">Start preparing with AI-driven mock interviews.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-center mt-6 text-sm text-gray-400">
              ...
              <Link to="/login" className="text-[#6C47FF] font-medium hover:text-white transition-colors drop-shadow-[0_0_8px_rgba(108,71,255,0.4)]">
                Sign in
              </Link>
            </p>
          </form>
